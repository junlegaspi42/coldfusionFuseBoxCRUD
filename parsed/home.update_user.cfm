...
<!--- circuit: home --->
<!--- fuseaction: update_user --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "home">
<cfset myFusebox.thisFuseaction = "update_user">
...
<cftry>
<cfoutput><cfinclude template="../model/users/act_update_user.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "act_update_user.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_update_user.cfm in circuit m_model which does not exist (from fuseaction m_model.update_user).">
